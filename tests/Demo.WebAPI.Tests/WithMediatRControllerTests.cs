...
public class WithMediatRControllerTests
{
    private const string BASE_ENDPOINT = "WithMediatR";
    ...
    public WithMediatRControllerTests(
    ...
    [Fact]
    [TestPriority(1)]
    public async void WithPolly_Add_Id()
    {
        // Arrange
    ...
    [Fact]
    [TestPriority(2)]
    public async void WithPolly_Update()
    {
        // Arrange
    ...
    [Fact]
    [TestPriority(3)]
    public async void WithPolly_Get()
    {
        // Arrange && Act
